...
set(LOONGARCH_VM_PROJECT_DIR "${CMAKE_CURRENT_LIST_DIR}" CACHE INTERNAL "")
...
function(DeclareCAmkESLoongarchVM init_component)
    ...
    if(VmVirtUart)
        list(APPEND vm_src ${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/src/modules/vuart_init.c)
    endif()

    if(Tk1DeviceFwd)
        list(
            APPEND vm_src ${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/src/modules/plat/tk1/device_fwd.c
        )
    endif()
    ...
    set(
        platform_module
        ${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/src/modules/plat/${KernelPlatform}/init.c
    )
    ...
    if(VmVirtioNetArping)
        list(APPEND vm_src ${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/src/modules/virtio_net_arping.c)
    endif()

    if(VmVirtioNetVirtqueue)
        list(
            APPEND vm_src ${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/src/modules/virtio_net_virtqueue.c
        )
    endif()

    if(VmVirtioConsole)
        list(APPEND vm_src ${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/src/modules/virtio_con.c)
    endif()
    ...
    elseif(KernelPlatformZynqmpUltra96v2)
        ...
        set(
            vm_plat_include
            "${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/plat_include/${KernelPlatform}"
        )
    endif()
    ...
    DeclareCAmkESComponent(
        ...
        INCLUDES
        ${LOONGARCH_VM_PROJECT_DIR}/components/VM_LoongArch/include
        ${vm_plat_include}
    ...
    # if("${KernelLoongarchPlatform}" STREQUAL "exynos5410")
    #     DeclareCAmkESComponent(${init_component} LIBS usbdrivers)
    # endif()

    # if("${KernelLoongArchSMMU}")
